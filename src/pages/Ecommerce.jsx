  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        {/* earnings */}
        <div className='dark:text-gray-200 dark:bg-secondary-dark-bg bg-white h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3  '>
      ...
      <div className='flex gap-10 fex-wrap justify-center'>
